...
function playVids(videoId) {
    ...
    if (vid.readyState > 3) {
        ...
        function trackLocation(e) {
            // Normalize to [0, 1]
            let boundingRect = videoMerge.getBoundingClientRect();
            position = ((e.pageX - boundingRect.x) / boundingRect.width);
        }
        function trackLocationTouch(e) {
            // Normalize to [0, 1]
            let boundingRect = videoMerge.getBoundingClientRect();
            position = ((e.touches[0].pageX - boundingRect.x) / boundingRect.width);
        }
